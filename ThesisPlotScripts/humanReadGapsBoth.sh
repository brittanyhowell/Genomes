#/bin/bash
gapDIR=/Users/brittanyhowell/Documents/University/Honours_2016/Thesis/Figures/gapHuman_bothIntron
FigDIR=Figures/gapHuman_bothIntron/
texDIR=/Users/brittanyhowell/Documents/University/Honours_2016/Thesis/appendices
newTex=${texDIR}/gapReadHumanBothIntron.tex
...
captionName=$(echo $filename | sed 's/_/-/g')
	...
	echo "\caption{Deletions occurring in reads which overlap human L1 elements. Reads were required to be entirely within L1 intervals, and have canonical introninc splice junction nucleotides at the 5' (/GT) and 3' (AG/). Black boxes indicate the portion of the L1 which was skipped in the aligned read. Reads generated from sample ${captionName}. Gaps detected with bamReader.go and plotted with coverageSplitReads.R}" >> ${newTex}
